        ...
        <nav class="relative z-10 px-9 py-8 bg-white h-full">
            <div class="flex flex-wrap justify-between h-full">
                ...
                <div class="flex flex-col justify-center py-8 w-full">
                    <ul>
                        <li class="mb-12"><a class="font-heading font-medium text-lg text-gray-900 hover:text-gray-700"
                                href="#">Features</a></li>
                        <li class="mb-12"><a class="font-heading font-medium text-lg text-gray-900 hover:text-gray-700"
                                href="#">Solutions</a></li>
                        <li class="mb-12"><a class="font-heading font-medium text-lg text-gray-900 hover:text-gray-700"
                                href="#">Resources</a></li>
                        <li><a class="font-heading font-medium text-lg text-gray-900 hover:text-gray-700"
                                href="#">Pricing</a></li>
                    </ul>
                </div>
            ...
            <div class="flex flex-wrap -m-6">
                <div class="w-full md:w-1/2 lg:w-5/12 p-6">
                    <div class="flex flex-col justify-between h-full max-w-sm">
                        ...
                        <div>
                            <p class="mb-14 text-gray-200 text-sm">Discover your next movie night effortlessly! With
                                our app, find out where to stream your favorite films in an instant. Dive into a world
                                of cinema, explore options, and never miss a scene again. Your ideal movie companion
                                awaits.</p>
                            <p class="text-gray-400 text-sm">© Copyright 2023. All Rights Reserved by Gradia.</p>
                        </div>
                    </div>
                </div>
                <div class="w-full md:w-1/2 lg:w-2/12 p-6">
                    <div class="h-full">
                        ...
                        <ul>
                            <li class="mb-4"><a
                                    class="font-heading font-medium text-base text-white hover:text-gray-200"
                                    href="#">Features</a></li>
                            <li class="mb-4"><a
                                    class="font-heading font-medium text-base text-white hover:text-gray-200"
                                    href="#">Pricing</a></li>
                            ...
                            <li><a class="font-heading font-medium text-base text-white hover:text-gray-200"
                                    href="#">Press Kit</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="w-full md:w-1/2 lg:w-3/12 p-6">
                    <div class="flex flex-col justify-between h-full">
                        <div>
                            <h3 class="mb-7 font-heading font-medium text-base text-gray-500 tracking-px">Contact
                                Info</h3>
                            <ul class="mb-6">
                                <li class="mb-4 font-heading font-medium text-base text-white">jobeauthement@gmail.com
                                </li>
                                <li class="font-heading font-medium text-base text-white">+1 (985) 262 5087</li>
                            </ul>
                        </div>
