...
@section('content')
    <section class="relative pt-24 pb-32 overflow-hidden">
        <div class="container mx-auto px-4">
            <h2 class="mb-5 max-w-xl mx-auto font-heading font-bold text-center text-6xl sm:text-7xl text-gray-900">
                    ...
                    <div class="flex flex-wrap -m-1.5">
                        <div class="w-auto px-1.5">
                            <svg class="relative top-1" width="24" height="24" viewbox="0 0 24 24" fill="none"
                                ...
                                <circle cx="12" cy="12" r="11.25" stroke="#18181B" stroke-width="1.5">
                                </circle>
            ...
            <div class="flex flex-wrap justify-center items-center -m-1">
                ...
                <div class="w-auto p-1">
                    <p class="text-gray-500 text-sm text-center" contenteditable="false">We don’t share or sell
                        your data.</p>
                </div>
            </div>
        </div>
